...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bitmap = BitmapFactory.decodeResource(getResources(), R.drawable.banana2);
        haha = findViewById(R.id.bobbutton);
        haha.setOnClickListener( v -> {
            sendNotification();
        });
        dwa = findViewById(R.id.pszycisknumerodos);
        dwa.setOnClickListener( v -> {
            sendNotificationLong();
        });
        fourth = findViewById(R.id.bananos);
        fourth.setOnClickListener( v -> {
            no1.sendNotification("Tytuł", "Zawartość", CHANNEL_ID,R.drawable.banana2, this);
        });
